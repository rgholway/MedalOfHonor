  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.textContainer}>
        ...
        <p>
          The Moung Phine Mission included one CIA Twin Engine Baron, two A-1E fighter aircraft, one H-1 rescue helicopter, and five troop carrying CH-3 helicopters that were transporting approximately 125 SGU’s from a CIA operating location on the Bolovens Plateau in Laos to a secure landing zone at the Moung Phine Airstrip (LS-300). The objective of these soldiers was to interrupt the flow of North Vietnamese Army (NVA) troops and equipment down the Ho Chi Minh trail into South Vietnam. It was a crucial location along the Ho Chi Minh trail connecting North Vietnam through Laos and into South Vietnam and Cambodia so keeping this trail open was the #1 priority of all NVA troops in Central Laos.
        </p>
        <p>
          Because of the importance of this location, the NVA had other plans as they had set a trap. They were waiting with anti-aircraft and other heavy weapons and proceeded to shoot down the lead helicopter (Knife 61), and USAF Major Conran now became the lead and led the remaining helicopters southeast out of the enemy fire zone while the two A-1 fighter pilots (Hobo 22 and 23) attempted to suppress the enemy fire.  Then, when Knife 61 reported a lull in enemy fire, Major Conran asked the H-1 rescue pilot to pick up the downed Knife 61 crew.  The pilot replied he felt the area was still too dangerous, his helicopter was unarmed, and he was low on fuel.  A quick decision had to be made whether to pull out and return to the base or go in and attempt a rescue of the downed crewmen. Major Conran concluded that there was no chance the men would survive without immediate additional support, so he chose to enter the hostile arena with the 25 Lao soldiers on board his helicopter. Fortunately for those comrades on the ground, Major Conran chose the more dangerous option to land his helicopter to stay and fight.
        </p>
        <p>
          During Major Conran’s approach, he too, took heavy enemy fire making the helicopter extremely difficult to control but he continued, landed, discharged the Lao soldiers, got the four Americans on board, and started to lift off before enemy bullets destroyed the helicopter transmission. The other three helicopters returned to base camp leaving Major Conran and the troops to defend themselves until they received additional air support or were rescued.
        </p>
        <p>
        ...
        <p>
          Because of Major Conran’s decisions and heroic efforts, after six long hours of fighting, 46 Lao Soldiers and 8 Americans were successfully airlifted from Moung Phine.
        </p>
        <p>
          What makes this operation even more remarkable is Major Conran was trained as an Air Force pilot and had no experience as a Marine Corps or Army combat officer, which is what he had to successfully perform for over six hours against a far superior heavily armed NVA force.  Read the supporting details in the Documents section of this website.
        </p>
        <p>
